...
if __name__ == '__main__':
   col = [[1,2,3,4],[2,4,6,8],[3,6,9,12]]
   err = [[0.1,0.5,0.07,0.01],[0.1,0.5,0.07,0.01],[0.1,0.5,0.07,0.01]]
   # print format_table( col, err, 1, latex=True)
   print type(round_sig(193.3184, 1))